...
const Side = () => {
    ...
    return (
        <aside className={`bg-white border-t-0 border-gray-200 max-w-[300px] w-full flex flex-col gap-2.5 border-1`}>
            <div className={`pt-4 w-full items-center flex flex-col gap-1`}>
            ...
            <div className={`px-4 flex flex-col gap-0 items-center`}>
