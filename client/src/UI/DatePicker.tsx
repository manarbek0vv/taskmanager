...
const DatePicker: FC<DatePickerProps> = ({ value, setData }) => {
    ...
    return (
        <div className={`overflow-hidden relative max-w-70 w-screen cursor-pointer items-center flex justify-between rounded-[5px] px-2 py-1 bg-gray-50 border-1 border-zinc-200`}>
